...
import {DefaultButton, Label, MessageBar, MessageBarType, Stack, TextField} from "@fluentui/react";
...
const TaskForm = ({editTaskId}: Props) => {
    ...
    useEffect(() => {
            if (editTaskId) {
                ...
                setStartDate(new Date(taskData?.date || new Date))
            }
        },
        [activeTasks])
    ...
    const [
        ...
        type: MessageBarType,
        message: string
    }>({type: MessageBarType.info, message: ''})
    ...
    const updateTaskAction = () => {
        ...
        if (taskData) {
            const data: ITask = {
                ...
                isDateClose: taskData.isDateClose,
            }
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Stack
                    style={{width: '20%' ,backgroundColor: '#177245',}}
                >
                    <DefaultButton
                        text={
